export function createPlatformData({ worldWidth, worldHeight, boundaryThickness, p1StartX, p2StartX, platformHeight }) {
  ...
  const midPlatforms = [
    ...
    { x: 440, y: worldHeight - 620, width: 280, height: platformHeight, angle: 0, label: 'platform-mid-step-left' },
    { x: worldWidth - 440, y: worldHeight - 620, width: 280, height: platformHeight, angle: 0, label: 'platform-mid-step-right' },
    { x: 1040, y: worldHeight - 750, width: 220, height: platformHeight, angle: 0, label: 'platform-upper-mid-left' },
    { x: worldWidth - 1040, y: worldHeight - 750, width: 220, height: platformHeight, angle: 0, label: 'platform-upper-mid-right' },
    { x: worldWidth / 2, y: worldHeight - 900, width: 300 * 2, height: platformHeight, angle: 0, label: 'platform-upper-mid-center' },
    { x: 700, y: worldHeight - 1050, width: 150, height: platformHeight, angle: Math.PI / 20, label: 'platform-high-far-left' },
    { x: worldWidth - 700, y: worldHeight - 1050, width: 150, height: platformHeight, angle: -Math.PI / 20, label: 'platform-high-far-right' },
    { x: 930, y: worldHeight - 1070, width: 340, height: platformHeight, angle: 0, label: 'platform-high-center-left' },
    { x: worldWidth - 930, y: worldHeight - 1070, width: 340, height: platformHeight, angle: 0, label: 'platform-high-center-right' },
    { x: worldWidth / 2, y: worldHeight - 1390, width: 320, height: platformHeight, angle: 0, label: 'platform-top-center' },
    { x: 1280, y: worldHeight - 1240, width: 300, height: platformHeight, angle: 0, label: 'platform-top-left' },
    { x: worldWidth - 1280, y: worldHeight - 1240, width: 300, height: platformHeight, angle: 0, label: 'platform-top-right' }
  ];
